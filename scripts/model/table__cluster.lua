...
cluster_table = {
    array = {"服务器名", "服务器介绍", "服务器密码", "服务器语言", "游戏风格", "游戏模式", "玩家上限", "开启PVP", "无人暂停", "开启投票", "开启控制台", "最大快照数", "是否使用多主机", "bind_ip", "master_ip", "master_port"},
    ["服务器名"] = {
        en = "cluster_name",
        value = "鸽子们的摸鱼日常",
